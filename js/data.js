/* ============================================================
   ...
   labelPos: l left · r right · a above · b below · ul upper-left · bl below-left
============================================================ */
/*__DATA__*/
...
{id:"l1",num:"1",zh:"一号线",en:"Line 1",color:"#f3d03e",cap:80,
 ...
 st:[
  ["西塱","Xīlǎng",100,950,"ul",["GF","22"]],
  ["坑口","Kēngkǒu",140,901,"ul"],
  ["花地湾","Huādìwān",180,852,"ul"],
  ["芳村","Fāngcūn",220,803,"ul",["GF"]],
  ["黄沙","Huángshā",260,754,"ul",["6"]],
  ["长寿路","Chángshòu Lù",300,705,"ul"],
  ["陈家祠","Chénjiācí",340,656,"ul",["8"]],
  ["西门口","Xīménkǒu",380,606,"ul"],
  ["公园前","Gōngyuánqián",420,557,"l"],
  ["农讲所","Nóngjiǎngsuǒ",476,543,"a"],
  ["烈士陵园","Lièshì Língyuán",532,528,"b"],
  ["东山口","Dōngshānkǒu",588,514,"a",["6"]],
  ["杨箕","Yángjī",644,499,"b",["5"]],
  ["体育西路","Tǐyù Xīlù",700,485,"bl"],
  ["体育中心","Tǐyù Zhōngxīn",762,452,"b"],
  ["广州东站","Guǎngzhōu Dōngzhàn",824,418,"r",["3","11"]]
 ],
 segKm:[1.4,0.9,0.9,1.7,0.9,0.9,0.8,0.9,1.0,0.9,1.2,1.6,1.8,1.0,1.6]},

{id:"l2",num:"2",zh:"二号线",en:"Line 2",color:"#1d80c4",cap:80,
 fact:"纵贯南北，一线连起广州南站与广州火车站两大铁路枢纽 · Links both major railway hubs.",
 st:[
  ["广州南站","Guǎngzhōu Nánzhàn",420,1085,"l",["7","22"]],
  ...
  ["市二宫","Shì'èrgōng",420,645,"l"],
  ["海珠广场","Hǎizhū Guǎngchǎng",420,601,"l",["6"]],
  ["公园前","Gōngyuánqián",420,557,"l"],
  ["纪念堂","Jìniàntáng",420,513,"l"],
...
{id:"l3",num:"3",zh:"三号线",en:"Line 3",color:"#f0862b",cap:120,
 ...
 st:[
  ...
  ["体育西路","Tǐyù Xīlù",700,485,"bl"],
  ["石牌桥","Shípáiqiáo",700,425,"r"],
  ["岗顶","Gǎngdǐng",700,365,"r"],
  ["华师","Huáshī",700,305,"r"],
  ["五山","Wǔshān",700,245,"r"],
  ["天河客运站","Tiānhé Kèyùnzhàn",700,185,"r",["6"]]
 ],
